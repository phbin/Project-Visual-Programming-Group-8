...
namespace QuanLiRapChieuPhim.DAO
{
    public class MenuDAO
    {
        ...
        public List<FDMenu> GetListMenuByBillID(int iDBill)
        {
            ...
            string query = "SELECT FD.NameFD, BI.Num, FD.Price, FD.Price*BI.Num AS TotalPrice FROM BillInfo BI, FoodDrink FD WHERE BI.IDFoodDrink = FD.ID AND BI.IDBill = " + iDBill;
